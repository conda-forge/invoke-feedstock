...
Development: https://github.com/pyinvoke/invoke
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=453&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/invoke-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `invoke` can be installed with `conda`:
...
It is possible to list all of the versions of `invoke` available on your platform with `conda`:
...
```
mamba search invoke --channel conda-forge
```
...
mamba repoquery search invoke --channel conda-forge

# List packages depending on `invoke`:
mamba repoquery whoneeds invoke --channel conda-forge

# List dependencies of `invoke`:
mamba repoquery depends invoke --channel conda-forge
```
